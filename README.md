...
## 🗺️ MakeCountry との連携について

このシステムは「MakeCountry」アドオンのプラグインとして統合することで、国家や領土のデータをマップ上に表示できます。

👉 **MakeCountry への導入手順は [README_MakeCountry.md](./README_MakeCountry.md) を参照してください。**
